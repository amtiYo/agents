...
export interface ProjectPaths {
  ...
  agentsCommandsDir: string;
  agentsHooksDir: string;
  claudeCommandsBridge: string;
  claudeHooksBridge: string;
}
...
export function getProjectPaths(projectRoot: string): ProjectPaths {
  ...
  return {
    ...
    generatedVscodeSettingsState: path.join(
      generatedDir,
    ...
    agentsCommandsDir: path.join(agentsDir, "commands"),
    agentsHooksDir: path.join(agentsDir, "hooks"),
    claudeCommandsBridge: path.join(root, ".claude", "commands"),
    claudeHooksBridge: path.join(root, ".claude", "hooks"),
  };
}
